angular.module('chatroom').service('messageService', function($http){
  ...
  this.getMessages = () => {
    return $http.get('https://practiceapi.devmountain.com/api/chats').then(res => res.data);
  }
  ...
  this.postMessage = (message) => {
    return $http.post('https://practiceapi.devmountain.com/api/chats', {message}).then(res => res.data);
  }
